namespace PirateFilter.Filters {
    ...
    /**
     * Class that inherites from // Filter // for applies the green filter in
     * the image.
     * */
    public class GreenFilter : Filter {
         ...
         * apllies the green filter. Creates a bytes array. After if has alpha,
         ...
         * the arrays and will see what byte is the blue and red byte and will put
         * their value in 0.
