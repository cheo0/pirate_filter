namespace Pirate_filter.Filters {
    public class GreenFilter : Filters.Filter {
        public void apply_filter (Gtk.Image image) {
            ...
            foreach (var i in new_bytes)
                stdout.printf ("%s   ", i.to_string ());
            ...
            var img_green = new Gtk.Image.from_pixbuf (new_buffer);
            new WindowFilter (Gtk.WindowType.POPUP, img_green);
        }
    }
}
